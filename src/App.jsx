...
function App() {
  ...
  return (
   ...
   {(difficulty==null)?<Difficulty setdifficulty={setdifficulty}/>:(result=="playing")?<Carddiv difficulty={difficulty} cards={cards} setscore={setscore} setresult={setresult} result={result} setcardsid={setcardsid} cardsid={cardsid} score={score}/>:(result=="won")?<Gamewon result={result} setresult={setresult} setscore={setscore}/>:<Gamelost setresult={setresult} setscore={setscore} setdifficulty={setdifficulty} setcardsid={setcardsid}/>}
   </div>
    </div>
  )
}
